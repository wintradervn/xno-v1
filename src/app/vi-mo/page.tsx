            ...
            <div className="flex items-center gap-3 text-sm text-muted">
              ...
              >
                {dateOptions?.map((item) => (
                  <SelectItem key={item} value={item} classNames={{}}>
                    {item}
                  </SelectItem>
                ))}
              </Select>
          ...
          >
            {tieuChiList.map((tieuChi) => (
              <AccordionItem
                key={tieuChi.id}
                title={
                  <div className="flex gap-2 text-medium font-medium uppercase">
                    {tieuChi.icon}
                  ...
                  <Accordion showDivider={false} selectionMode="multiple">
                    {tieuChi.children?.map((child) => (
                      <AccordionItem
                        ...
                        classNames={{
                          trigger: "pr-1 py-2 !border-none outline-none",
                      ...
                      >
                        {child.children?.map((subChild) => (
                          <div
                            key={subChild.id}
                            className={cn(
                              "flex cursor-pointer select-none items-center justify-between gap-2 p-2 pl-10 hover:bg-content1",
