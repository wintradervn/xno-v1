...
export default function NetWorkStrengthComponent() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-fit w-[42px] min-w-0 flex-col items-center !bg-transparent px-2 py-2 text-muted transition-colors hover:text-white",
        )}
      >
        <HomeWifi size={24} />
        <span className={cn("text-nowrap text-2xs font-semibold")}>
          Kết nối
        </span>
      </div>
    </Tooltip>
