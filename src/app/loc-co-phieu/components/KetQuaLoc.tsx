...
export default function KetQuaLoc() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col">
      <div className="card flex h-full flex-1 flex-col gap-2 rounded-[8px] p-3">
        <div className="flex items-center justify-between">
          <div className="flex w-fit items-center gap-1 py-1 text-md font-medium text-white">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <path
                ...
                fill="url(#paint0_linear_31320_255522)"
              />
              <path
                ...
                fill="url(#paint1_linear_31320_255522)"
              />
              <path
                ...
                fill="url(#paint2_linear_31320_255522)"
              />
              <path
                ...
                fill="url(#paint3_linear_31320_255522)"
              />
              <defs>
                <linearGradient
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <SelectItem key="all">Tất cả các sàn</SelectItem>
            ...
            <Select
              ...
              selectionMode="single"
            >
              <SelectItem key="all">Tất cả các ngành</SelectItem>
              <SelectItem key="HOSE">HOSE</SelectItem>
              <SelectItem key="HNX">HNX</SelectItem>
              <SelectItem key="UPCOM">UPCOM</SelectItem>
            </Select>
        ...
        <Table
          ...
          classNames={{
            header:
              "bg-neutral-800 -mx-3 px-3 max-h-11 text-white items-start py-1",
            row: "border-b-1 border-neutral-800 h-[48px] -mx-3 px-3",
          }}
        />
      </div>
    </div>
