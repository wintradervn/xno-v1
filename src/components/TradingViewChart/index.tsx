  ...
  useEffect(() => {
    ...
    tvWidget.onChartReady(() => {
      ...
      tvWidget.applyOverrides({
        ...
        "paneProperties.background": "#151A24",
        "mainSeriesProperties.candleStyle.upColor": "#1BF81F",
        "mainSeriesProperties.candleStyle.borderUpColor": "#1BF81F",
        "mainSeriesProperties.candleStyle.wickUpColor": "#1BF81F",
