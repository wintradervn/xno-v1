...
function BotItem() {
  return (
    <div className="rounded-[8px] border-[1.3px] border-default-800 p-2 text-sm">
      ...
      <div className="flex items-center justify-between py-1">
        <div className="flex flex-col">
          ...
          <div className="text-lg font-semibold text-green">7,32%</div>
        </div>
        <div>
          <svg
            width="60"
      ...
      <div className="text-xs text-muted">Thời gian hoạt động</div>
      <div className="mb-1 font-semibold">5 ngày 11 giờ 7 phút</div>
      <div className="text-xs text-muted">Tổng số người giao dịch bot</div>
...
function BotGiaoDich() {
  return (
    <div className="flex h-full flex-col">
      <div className="text-xs text-muted">Bot cổ phiếu</div>
