              ...
              .map((item, index) => (
                ...
                >
                  <div className="relative ml-14 h-4 flex-1">
                    <div
                      className="absolute right-0 h-4 rounded-[4px] bg-green"
                      style={{
                        width: `calc(${(item.dayNetVal / maxValue) * 100 + "%"})`,
                      }}
                    ></div>
                    <div
                      className="absolute text-nowrap text-[11px] text-green"
                      style={{
              ...
              .map((item, index) => (
                ...
                >
                  ...
                  <div className="relative mr-14 h-4 flex-1">
                    <div
                      className="absolute left-0 h-4 rounded-[4px] bg-red"
                      style={{
                        width: `calc(${(Math.abs(item.dayNetVal) / maxValue) * 100 + "%"})`,
                      }}
                    ></div>
                    <div
                      className="absolute text-nowrap text-[11px] text-red"
                      style={{
